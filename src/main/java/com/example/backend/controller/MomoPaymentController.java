...
public class MomoPaymentController {
  ...
  @Operation(summary = "Create MoMo payment", description = "Generate a MoMo payment URL for checkout.")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Payment URL created successfully", content = @Content(mediaType = "application/json")),
      @ApiResponse(responseCode = "400", description = "Bad request - invalid payment data", content = @Content(mediaType = "application/json")),
  ...
  @Operation(summary = "Handle MoMo IPN callback", description = "Process payment callback from MoMo payment gateway.")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "IPN processed successfully", content = @Content(mediaType = "application/json")),
      @ApiResponse(responseCode = "400", description = "Bad request - invalid signature", content = @Content(mediaType = "application/json")),
      @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content)
  })
  @PostMapping("/ipn")
  public ResponseEntity<?> ipn(@RequestBody MomoIpnRequest ipn) {
    ...
    try {
      String rawSignature = "amount=" + ipn.getAmount() +
  ...
  @Operation(summary = "Handle MoMo return URL", description = "Process return URL callback from MoMo payment gateway.")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Return processed", content = @Content(mediaType = "application/json")),
      @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content)
  })
  @GetMapping("/return")
